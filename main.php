...
<head>
    <meta charset="utf-8">
    <meta name="author" content="Miroslav Jarý, jason@vyfuk.org">
    ...
    <title>
        <?php echo tpl_functions::getPageTitle($ID); ?>
    </title>
    <?php
...
<body data-act="<?php echo $ACT; ?>" data-namespace="<?php echo getNS($ID); ?>" data-page_id="<?php echo $ID; ?>">
        ...
        <div class="parallax-fg">
            ...
            <footer>
                ...
                <div class="footer-content">
                    <div
                        class="container row m-auto align-items-center justify-content-center justify-content-lg-between">
                        <div class="col-lg order-lg-2 py-1">
                            ...
                            <a href="/o_webu">©
                                <?php echo date("Y") ?> Výfuk
                            </a><br>
                            Neváhej nás kontaktovat!<br>
                            <a href="mailto:vyfuk@vyfuk.org">vyfuk@vyfuk.org</a>
                        </div>
                        ...
                        <div class="social col-lg order-lg-1 row no-gutters py-1">
                            <a class="col-3 px-1" href="https://facebook.com/ksvyfuk">
                                <?php echo file_get_contents(__DIR__ . "/icons/vyfuk-fb.svg"); ?>
                            </a>
                            <a class="col-3 px-1" href="https://www.instagram.com/ksvyfuk/">
                                <?php echo file_get_contents(__DIR__ . "/icons/vyfuk-ig.svg"); ?>
                            </a>
                            <a class="col-3 px-1" href="https://www.youtube.com/channel/UCUBv3Ydd-laLSY5DMimoE7w">
                                <?php echo file_get_contents(__DIR__ . "/icons/vyfuk-yt.svg"); ?>
                            </a>
                            <a class="col-3 px-1" href="/discord">
                                <?php echo file_get_contents(__DIR__ . "/icons/vyfuk-dc.svg"); ?>
                            </a>
                        </div>
                        <div
                            class="d-flex flex-column flex-lg-row align-items-center justify-content-around py-2 order-lg-3">
                            <a class="col" href="https://www.msmt.cz/">
                                <img width="180" src="/lib/tpl/vyfuk/images/logo-msmt.png" alt="MŠMT ČR">
                            </a>
                            <span class="col align-self-end my-3 my-lg-0">Realizace projektu byla podpořena
                                Ministerstvem školství, mládeže a tělovýchovy.</span>
    ...
    <noscript class="noscript">
        <div class="alert alert-danger position-fixed top-50 start-50 translate-middle text-center" id="no-js-warning"
            role="alert">
            Je nám líto, ale pro správné fungování stránky musíte aktivovat <a
                href="https://www.enable-javascript.com/cz/">JavaScript</a>.
        </div>
    </noscript>
